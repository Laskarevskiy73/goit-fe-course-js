...
const createGalleryItems = (list, item) => {
  item.map(element => {
    const listItems = document.createElement('li');
    listItems.classList.add('list-item');
    let tagImg = document.createElement('img');
    tagImg.classList.add('styling-image');
    tagImg.src = element.url;
    tagImg.alt = element.alt;
    listItems.append(tagImg);

    list.append(listItems);
  });
};

createGalleryItems(gallery, galleryItems);
